...
public class APLootTables extends LootTableProvider {
    ...
    private static class APBlockLoot extends BlockLootSubProvider {
        ...
        protected void generate() {
            ...
            this.add(APBlocksFG.TWISTED_LEAVES.get(), (leaves) -> this.createLeavesDrops(leaves, APBlocksFG.TWISTED_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        }
        ...
        protected Iterable<Block> getKnownBlocks() {
            ...
            blocks.add(APBlocksFG.TWISTED_LEAVES.get());
            return blocks;
