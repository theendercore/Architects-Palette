...
import static architectspalette.core.registry.util.RegistryUtilsFG.createBlockNoItem;
...
public class APBlocksFG {
    ...
    public static final RegistryObject<Block>    COD_SCALES = createBlock("cod_scales",    () -> new RotatedPillarBlock(APBlockPropertiesFG.Meat(MapColor.TERRACOTTA_YELLOW)));
     // Entrails
    public static final StoneBlockSet ENTRAILS = new StoneBlockSet(createBlock("entrails", () -> new DrippyBlock(APBlockPropertiesFG.Meat(MapColor.TERRACOTTA_PINK))), NO_WALLS).usesAxe();
     // Plating & Piping
    public static final StoneBlockSet PLATING_BLOCK = new StoneBlockSet(createBlock("plating_block", () -> new Block(APBlockPropertiesFG.PLATING)), TYPICAL, NUB);
...
//    public static final RegistryObject<Block> CHARCOAL_BLOCK = createBlockNoItem("charcoal_block", () -> new RotatedPillarBlock(Block.Properties.ofFullCopy(Blocks.COAL_BLOCK)));
    ...
    public static final StoneBlockSet MYONITE             = new StoneBlockSet(createBlock("myonite",              () -> new Block(APBlockPropertiesFG.MYONITE)));
    public static final StoneBlockSet MYONITE_BRICK       = new StoneBlockSet(createBlock("myonite_bricks",       () -> new Block(APBlockPropertiesFG.MYONITE)));
    public static final StoneBlockSet MUSHY_MYONITE_BRICK = new StoneBlockSet(createBlock("mushy_myonite_bricks", () -> new Block(APBlockPropertiesFG.MYONITE)));

    // Olivestone
    public static final StoneBlockSet OLIVESTONE_BRICK = new StoneBlockSet(createBlock("olivestone_bricks", () -> new Block(APBlockPropertiesFG.OLIVESTONE)));
    public static final StoneBlockSet OLIVESTONE_TILE  = new StoneBlockSet(createBlock("olivestone_tiles",  () -> new Block(APBlockPropertiesFG.OLIVESTONE)));
    ...
    // Algal Brick
    public static final StoneBlockSet ALGAL_BRICK = new StoneBlockSet(createBlock("algal_bricks", () -> new Block(APBlockPropertiesFG.ALGAL_BRICK)));
    ...
    public static final StoneBlockSet OVERGROWN_ALGAL_BRICK = new StoneBlockSet(createBlock("overgrown_algal_bricks", () -> new Block(APBlockPropertiesFG.ALGAL_BRICK)));
//    public static final RegistryObject<Block> ALGAL_LAMP = createBlock("algal_lamp", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.SEA_LANTERN)));
    ...
    public static final StoneBlockSet FLINT_TILES  			= new StoneBlockSet(createBlock("flint_tiles",  () -> new FlintBlock(APBlockPropertiesFG.FLINT)));
    ...
    // Polished Packed Ice
    public static final StoneBlockSet POLISHED_PACKED_ICE = new StoneBlockSet(createBlock("polished_packed_ice", () -> new Block(APBlockPropertiesFG.BUILDING_ICE)));
    ...
    // Sunmetal
    public static final StoneBlockSet SUNMETAL = new StoneBlockSet(createBlock("sunmetal_block", () -> new Block(APBlockPropertiesFG.SUNMETAL)), NO_WALLS, NUB);
    ...
    public static final RegistryObject<Block> SUNMETAL_BARS           = createBlock("sunmetal_bars", () -> new IronBarsBlock(APBlockPropertiesFG.SUNMETAL.noOcclusion()));
...
//    public static final RegistryObject<Block> WITHER_LAMP = createBlock("wither_lamp", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.SEA_LANTERN)));
    ...
    // Entwine
    public static final StoneBlockSet ENTWINE = new StoneBlockSet(createBlock("entwine_block", () -> new Block(APBlockPropertiesFG.ENTWINE)), NO_WALLS);
    ...
    public static final RegistryObject<Block> ENTWINE_BARS = createBlock("entwine_bars", () -> new IronBarsBlock(BlockBehaviour.Properties.ofFullCopy(ENTWINE.get()).noOcclusion()));
...
//    public static final RegistryObject<Block> CHISELED_END_STONE_BRICKS = createBlock("chiseled_end_stone_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.END_STONE_BRICKS)));
    ...
    public static final StoneBlockSet TWISTED_PLANKS = new StoneBlockSet(createBlock("twisted_planks", () -> new Block(APBlockPropertiesFG.TwistedWood())), NO_WALLS).woodify();

    public static final RegistryObject<Block>  STRIPPED_TWISTED_LOG = createBlock("stripped_twisted_log", () -> new RotatedPillarBlock(APBlockPropertiesFG.TwistedWood()));
    public static final RegistryObject<Block> STRIPPED_TWISTED_WOOD = createBlock("stripped_twisted_wood",() -> new RotatedPillarBlock(APBlockPropertiesFG.TwistedWood()));
    public static final RegistryObject<Block>           TWISTED_LOG = createBlock("twisted_log",          () -> new StrippableLogBlock(APBlockPropertiesFG.TwistedWood(), STRIPPED_TWISTED_LOG.get()));
    public static final RegistryObject<Block>          TWISTED_WOOD = createBlock("twisted_wood",         () -> new StrippableLogBlock(APBlockPropertiesFG.TwistedWood(), STRIPPED_TWISTED_WOOD.get()));
    ...
    public static final RegistryObject<Block>         TWISTED_FENCE = createBlock("twisted_fence",        () -> new         FenceBlock(APBlockPropertiesFG.TwistedWood()), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistryObject<Block>    TWISTED_FENCE_GATE = createBlock("twisted_fence_gate",   () -> new     FenceGateBlock(WoodType.OAK, APBlockPropertiesFG.TwistedWood(), SoundEvents.FENCE_GATE_CLOSE, SoundEvents.FENCE_GATE_OPEN), CreativeModeTabs.BUILDING_BLOCKS, CreativeModeTabs.REDSTONE_BLOCKS);
    public static final RegistryObject<Block>          TWISTED_DOOR = createBlock("twisted_door",         () -> new          DoorBlock(BlockSetType.OAK, APBlockPropertiesFG.TwistedWood().noOcclusion()), CreativeModeTabs.BUILDING_BLOCKS, CreativeModeTabs.REDSTONE_BLOCKS);
    public static final RegistryObject<Block>      TWISTED_TRAPDOOR = createBlock("twisted_trapdoor",     () -> new      TrapDoorBlock(BlockSetType.OAK, APBlockPropertiesFG.TwistedWood().noOcclusion()), CreativeModeTabs.BUILDING_BLOCKS, CreativeModeTabs.REDSTONE_BLOCKS);
    public static final RegistryObject<Block>        TWISTED_BUTTON = createBlock("twisted_button",
            () -> new    ButtonBlock(BlockSetType.OAK, 30, APBlockPropertiesFG.TwistedWood(true)), CreativeModeTabs.BUILDING_BLOCKS, CreativeModeTabs.REDSTONE_BLOCKS);
    public static final RegistryObject<Block> TWISTED_PRESSURE_PLATE = createBlock("twisted_pressure_plate",
            () -> new PressurePlateBlock(BlockSetType.OAK, APBlockPropertiesFG.TwistedWood(true)), CreativeModeTabs.BUILDING_BLOCKS, CreativeModeTabs.REDSTONE_BLOCKS);
...
//    public static final RegistryObject<Block> HEAVY_CRACKED_END_STONE_BRICKS = createBlock("heavy_cracked_end_stone_bricks", () -> new BigBrickBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.END_STONE_BRICKS), BigBrickBlock.BrickType.END_STONE));
    ...
    public static final RegistryObject<Block> GRINNING_ACACIA_TOTEM = createBlock("grinning_acacia_totem", () -> new TotemBlock(APBlockPropertiesFG.ACACIA_TOTEM, ACACIA_TOTEM_WING.get(), TotemBlock.TotemFace.GRINNING));
    public static final RegistryObject<Block> PLACID_ACACIA_TOTEM   = createBlock("placid_acacia_totem",   () -> new TotemBlock(APBlockPropertiesFG.ACACIA_TOTEM, ACACIA_TOTEM_WING.get(), TotemBlock.TotemFace.PLACID));
    public static final RegistryObject<Block> SHOCKED_ACACIA_TOTEM  = createBlock("shocked_acacia_totem",  () -> new TotemBlock(APBlockPropertiesFG.ACACIA_TOTEM, ACACIA_TOTEM_WING.get(), TotemBlock.TotemFace.SHOCKED));
    public static final RegistryObject<Block> BLANK_ACACIA_TOTEM    = createBlock("blank_acacia_totem",    () -> new TotemBlock(APBlockPropertiesFG.ACACIA_TOTEM, ACACIA_TOTEM_WING.get(), TotemBlock.TotemFace.BLANK));
    ...
    public static final BlockNode TWISTED_BOARDS  = createBoardNode("twisted_boards", () -> new Block(APBlockPropertiesFG.TwistedWood()));
...
//    public static final RegistryObject<Block> UNOBTANIUM_BLOCK = createBlock("unobtanium_block", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.NETHERITE_BLOCK)));
    ...
    // Nether Brass
    public static final StoneBlockSet NETHER_BRASS = new StoneBlockSet(createBlock("nether_brass_block", () -> new Block(APBlockPropertiesFG.NETHER_BRASS)), TYPICAL, NUB);
    public static final StoneBlockSet CUT_NETHER_BRASS = new StoneBlockSet(createBlock("cut_nether_brass", () -> new Block(APBlockPropertiesFG.NETHER_BRASS)));
    ...
    public static final StoneBlockSet SMOOTH_NETHER_BRASS = new StoneBlockSet(createBlock("smooth_nether_brass", () -> new Block(APBlockPropertiesFG.NETHER_BRASS)), NO_WALLS);
    ...
    public static final StoneBlockSet ESOTERRACK = new StoneBlockSet(createBlock("esoterrack", () -> new Block(APBlockPropertiesFG.ESOTERRACK)));
    public static final StoneBlockSet ESOTERRACK_BRICKS = new StoneBlockSet(createBlock("esoterrack_bricks", () -> new Block(APBlockPropertiesFG.ESOTERRACK)));
    ...
    public static final StoneBlockSet ONYX = new StoneBlockSet(createBlock("onyx", () -> new Block(APBlockPropertiesFG.ONYX)));
    public static final StoneBlockSet ONYX_BRICKS = new StoneBlockSet(createBlock("onyx_bricks", () -> new Block(APBlockPropertiesFG.ONYX)));
    ...
    public static final StoneBlockSet WARDSTONE = new StoneBlockSet(createBlock("wardstone", () -> new Block(APBlockPropertiesFG.WARDSTONE)));
    ...
    public static final StoneBlockSet WARDSTONE_BRICKS = new StoneBlockSet(createBlock("wardstone_bricks", () -> new Block(APBlockPropertiesFG.WARDSTONE)));
    ...
    public static final StoneBlockSet ANCIENT_PLATING = new StoneBlockSet(createBlock("ancient_plating", () -> new Block(APBlockPropertiesFG.ANCIENT_PLATING)), TYPICAL, FENCE);
    ...
    public static final BlockNode TREAD_PLATE = new Builder()
            .tool(Tool.IRON_PICK)
            .style(Style.CUBE)
            .base(createBlock("tread_plate", () -> new Block(APBlockPropertiesFG.PLATING)))
            .slabs()
    ...
    public static final BlockNode SHEET_METAL = new Builder()
            .tool(Tool.PICK)
            .base(createBlock("sheet_metal_block", () -> new Block(APBlockPropertiesFG.PLATING)))
            .variants(WALL)
            .build();
    ...
    public static final BlockNode ORACLE_BLOCK = new Builder()
            .tool(Tool.PICK)
            .base(createBlock("oracle_block", () -> new Block(APBlockPropertiesFG.ORACLE)))
            .slabs()
            ...
            .addPart(LAMP, b -> b.base(createBlock("oracle_lamp", () -> new Block(APBlockPropertiesFG.ORACLE_LAMP))))
            .build();

    public static final BlockNode CEREBRAL_BLOCK = new Builder()
            .tool(Tool.PICK)
            .base(createBlock("cerebral_block", () -> new Block(APBlockPropertiesFG.CEREBRAL)))
            .slabs()
    ...
    public static final BlockNode MOONSHALE = new Builder()
            .tool(Tool.PICK)
            .base(createBlock("moonshale", () -> new Block(APBlockPropertiesFG.MOONSHALE)))
            .commonVariants()
            .exclude(MODELS)
            .variants(CHISELED)
            .bricks(b -> {
    ...
    public static final BlockNode CRATERSTONE = new Builder()
            .tool(Tool.PICK)
            .base(createBlock("craterstone", () -> new Block(APBlockPropertiesFG.MOONSHALE)))
            .commonVariants()
            .build();
    public static final BlockNode NEBULITE = new Builder()
            .tool(Tool.PICK)
            .base(createBlock("nebulite", () -> new Block(APBlockPropertiesFG.NEBULITE)))
            .commonVariants()
            .addPart(POLISHED, b -> {
                b.slabs();
                b.addPart(STAIRS);
