...
public class APAdvancements implements ForgeAdvancementProvider.AdvancementGenerator {
    ...
    protected static Advancement.Builder getAdvancement(Advancement parent, ItemLike display, String name, AdvancementType frame, boolean showToast, boolean announceToChat, boolean hidden) {
    ...
    public void generate(HolderLookup.Provider registries, Consumer<Advancement> advancementConsumer, ExistingFileHelper existingFileHelper) {
        ...
        Advancement totemCarving = getAdvancement(architectsPalette, APBlocks.PLACID_ACACIA_TOTEM.get().asItem(), "totem_carving", AdvancementType.TASK, true ,true, false)
        ...
        Advancement whatACatch = getAdvancement(architectsPalette, APBlocks.COD_LOG.get().asItem(), "buy_fish_block", AdvancementType.TASK, true, false, false)
        ...
        Advancement placeEntrails = getAdvancement(buyEntrails, APBlocks.ENTRAILS.get().asItem(), "place_entrails", AdvancementType.TASK, true, true, true)
        ...
        Advancement buyCelestialStone = getAdvancement(architectsPalette, APBlocks.SUNSTONE.get().asItem(), "buy_celestial_stone", AdvancementType.TASK, true, false, false)
