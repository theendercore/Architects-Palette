...
public class APBlocks {
    ...
    // Ore Bricks
    public static final BlockNode COAL_BRICKS = createOreBrickNode("coal");
    public static final BlockNode LAPIS_BRICKS = createOreBrickNode("lapis");
    public static final BlockNode REDSTONE_BRICKS = createOreBrickNode("redstone");
    public static final BlockNode IRON_BRICKS = createOreBrickNode("iron");
    public static final BlockNode GOLD_BRICKS = createOreBrickNode("gold");
    public static final BlockNode EMERALD_BRICKS = createOreBrickNode("emerald");
    public static final BlockNode DIAMOND_BRICKS = createOreBrickNode("diamond");
    // Flint Blocks
    ...
    public static final BlockNode CHERRY_BOARDS = createBoardNode("cherry_boards", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.CHERRY_PLANKS)));
    public static final BlockNode BAMBOO_BOARDS = createBoardNode("bamboo_boards", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BAMBOO_PLANKS)));
    ...
    public static final Supplier<Block> NETHER_BRASS_CHAIN = createBlock("nether_brass_chain", () -> new ChainBlock(BlockBehaviour.Properties.ofFullCopy(NETHER_BRASS.get()).sound(SoundType.CHAIN).noOcclusion().forceSolidOn()));
    ...
    public static final BlockNode BREAD_BLOCK = new BlockNode.Builder()
            ...
            .addPart(BlockNode.BlockType.SLAB, b -> b.exclude(MODELS))
